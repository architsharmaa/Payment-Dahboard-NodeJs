...
async function billerPaymentData(req,res){
    
    try{

        //fetching filters from request body
        const {userId, confirmationNumber, paymentType,
             channel, paymentAmountMinRange,paymentAmountMaxRange, 
...
module.exports = billerPaymentData;